...
public class VentanaGestionVentas extends JFrame {
	...
	// Se crea un cordinador_ventas porque tiene un metodo para poder regresar a la
	// ventana de inicio
	...
	public static void main(String tipoConex) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaGestionVentas window = new VentanaGestionVentas(tipoConex);
	...
	private void initialize(String tipoConex) {
		...
		botonVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				coordinador_ventas.mostrarVentanaMenuPrincipal(tipoConex);
				setVisible(false);
			}
		});
